    ...
    if($pswd1 == $pswd2)
        {
            ...
            $query = mysqli_query($conn,"SELECT * FROM login_tbl WHERE user_name='$name' AND usr_password='$pswd' AND category='Employee'"); // selecting data through mysql_query()
            $rowquery = mysqli_num_rows($query);
            if ($rowquery == 1)
            {
                $query1=mysqli_query($conn,"UPDATE login_tbl SET usr_password='$pswd1' WHERE user_name='$name' AND usr_password='$pswd' AND category='Employee'");
                echo'<script>';
...
?>
    ...
    Enter  username &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='sline' type="text" name="usr" required><br><br>
    Enter the password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='sline' type="password" name="pass" required><br><br>
	Enter new password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id='sline' type="password" name="pass_1" required><br><br>
	Confirm new password &nbsp;<input  id='sline' type="password" name="pass_2" required><br><br>
