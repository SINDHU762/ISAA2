...
if(isset($_GET['update_product']))
    ...
    if ($pcount == 1)
    {
        ...
        else
        {
            ...
            setTimeout(function () {
                ...
                window.location.replace("admin_purchase.php"); //will redirect to main page (index.html)
    ...
    /*
     ...
     if ($productq > $pquantity)
     {  
         $query6 = mysqli_query($conn,"UPDATE product SET p_quantity=((p_quantity-'$productq')+'$pquantity'),mrp='$pmrp',p_name='$pname',b_name='$bname',p_cat='$cat' WHERE p_id='$pid'");
     ...
     if ($productq == $pquantity)
     {
        $query9 = mysqli_query($conn,"UPDATE product SET b_name='$bname' p_name='$pname',mrp='$pmrp',p_cat='$cat' WHERE p_id='$pid'");
     }
     $query9 = mysqli_query($conn,"UPDATE product SET p_cat='$cat' WHERE p_id='$pid'");
     $query = mysqli_query($conn, "UPDATE purchase SET product_id='$pid',product_name='$pname',brand_name='$bname',product_cat='$cat',purchasing_price='$pprice',product_quantity='$pquantity',total_price='$tprice',p_mrp='$pmrp',purchase_date='$pdate' WHERE purchase_id='$purid'");
     */
