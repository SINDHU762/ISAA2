<?php
  ...
  { 
    $od_no = trim($_POST["order_no"]);
    $query = mysqli_query($conn, "SELECT * FROM tbl_order WHERE order_no=$od_no");
...
<body style="background-color:#d9d9d9">
  <body>
    ...
    <div class="container-fluid">
            ...
            <tr>
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    ...
                    <?php
                    $statement = $connect->prepare("SELECT * FROM tbl_order_item 
                      WHERE order_id = :order_id
                    ");
                    $statement->execute(
                      array(
      ...
      <br />
      <div align="right">
        <a href="admin_invoice.php?add=1" class="btn btn-info btn-xs">Create</a>
      </div>
      <br />
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="delete_invoice.php?id='.$row["order_id"].'"" class="delete"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
