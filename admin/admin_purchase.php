...
<tr>
 ...
 $query = mysqli_query($conn,"SELECT * FROM purchase "); // selecting data through mysql_query()
    ...
    echo '
      <tr>
        ...
        <td><a href="admin_update_purchase.php?purchase_id='.$row['purchase_id'].'" data-toggle="tooltip" data-placement="top" title="UPDATE">
  <i class="fa fa-edit" aria-hidden="true"></a></i></td>
  <td><a href="delete_purchase.php?purchase_id='.$row['purchase_id'].'" data-toggle="tooltip" data-placement="top" title="DELETE">
  <i class="fa fa-trash" aria-hidden="true"></a></i></td>
